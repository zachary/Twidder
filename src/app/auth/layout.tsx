    ...
    return (
        <main className={`flex h-screen flex-col items-center justify-start relative gap-10`}>
            <nav className={`flex justify-center items-center gap-8 w-full h-7 py-6 border-b-[0.5px] border-b-zinc-800 text-white/90 text-sm backdrop-blur-xl relative z-10`}>
                ...
                <Link className={`text-pretty`} href={"/posts/list"}>Scheduled</Link>
            </nav>
            ...
            <section className={`h-[70vh] w-2/5 min-w-[480px] grid place-items-center place-content-center border rounded-lg border-zinc-500 relative bg-transparent backdrop-blur z-4`}>
                {
                  children
                }
            </section>
